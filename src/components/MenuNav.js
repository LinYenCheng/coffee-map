...
class MenuNav extends Component {
    constructor(props) {
        super(props);
        this.handleChangeChkTaipei = this.handleChangeChkTaipei.bind(this);
        ...
        return (
            <nav className="navmenu">
                <ul id="nav_ul">
                    <li>
                        <div className="wrap">
                            <div className="li-word">台北</div>
                            <input type="checkbox" checked={stateChk.chkTaipei} onChange={this.handleChangeChkTaipei} id="chkTaipei"/>
                            <label className="slider-v3" htmlFor="chkTaipei"></label>
                        </div>
                    </li>
                    <li>
                        <div className="wrap">
